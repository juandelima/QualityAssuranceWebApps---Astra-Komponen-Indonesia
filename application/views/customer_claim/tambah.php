...
<body class="page-body skin-facebook" data-url="http://neon.dev">
	<div class="page-container">
		...
		<?php $this->load->view('_partials/navbar_head.php'); ?>
			<h2>Add Customer Claim (AHM)</h2>
			<ol class="breadcrumb bc-3">
				<li>
					<a href="<?php echo base_url('claim/customerclaim/ahm') ?>"><i class="entypo-home"> Customer Claim (AHM)</i></a>
				</li>
				<li class="active">
					<strong>Add Customer Claim (AHM)</strong>
				</li>
			</ol>
							...
							<form role="form" id="create_claim" class="form-horizontal" action="<?php echo base_url('claim/customerclaim/save'); ?>" method="post">
								...
								<div id="part_1" style="margin-top: 15px;">
									<div class="form-group">
										...
										<a class="btn btn-white icon-left" id="search_part" href="javascript:;" onclick="jQuery('#modal-1').modal('show', {backdrop: 'static'});">
