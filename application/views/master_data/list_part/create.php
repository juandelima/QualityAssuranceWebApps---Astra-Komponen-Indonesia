			...
			<div class="row">
				...
				<div class="panel panel-primary" data-collapsed="0">
						<div class="panel-body">
							<form role="form" class="form-horizontal" action="<?php echo base_url('masterdata/listpart/save'); ?>" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="autocomplete form-control" id="id_customer" name="id_customer" placeholder="AHM/AHD/AVI" required>
									</div>
								</div>
			...
			$('#no_sap').autocomplete({
				...
				response: function(event, ui) {
            		if (ui.content.length === 0) {
						$("#empty-message").css('color', 'red').append('DATA PART TIDAK DITEMUKAN!. KLIK <a href="<?php echo base_url('masterdata/listpart/data_parts'); ?>">DISINI</a> UNTUK MENAMBAHKAN LISTPART TERBARU.');
