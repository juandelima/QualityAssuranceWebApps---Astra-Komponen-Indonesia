	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">
				<li>
					<a href="<?php echo base_url() ?>"><i class="entypo-home"> Dashboard</i></a>
				</li>
				<li class="active">
								...
								<div class="form-group">
									...
									<div id="msg"></div>
										...
										<!-- <div class="form-group">
											...
											<div class="col-sm-5">
												<a class="btn btn-danger btn-block" href="#">RESET PASSWORD</a>
											</div>
										</div> -->
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-sm-5">
												...
												<select name="role" class="form-control" <?php if($this->session->userdata['role'] != 'Super Admin') { ?> disabled <?php } ?>>
													<?php 
